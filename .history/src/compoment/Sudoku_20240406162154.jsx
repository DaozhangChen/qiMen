...
function Sudoku() {
    const regionArr = [
        ...
        { number: 9, area: "离", initDownStem: "午" },
        { number: 2, area: "坤", initDownStem: "未" },
        { number: 3, area: "震", initDownStem: "卯" },
        { number: 5, area: "中" },
        { number: 7, area: "兑", initDownStem: "酉" },
        { number: 8, area: "艮", initDownStem: "丑" },
        { number: 1, area: "坎", initDownStem: "子" },
        { number: 6, area: "乾", initDownStem: "亥" }
    ]
            ...
            <div className="sudoku-grid">
                ...
                {regionArr.map((value) => (
                    <div key={value.number} className="sudoku-row" data-key={value.number}>
                        {
                            value.number !== 5 ? <div className={"downStem1-" + value.number}>{value.initDownStem}</div> : null
                        }
                        {
